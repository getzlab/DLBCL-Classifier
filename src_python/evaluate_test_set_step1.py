...
base_fn = 'NN_reducedV3.4_removeN5_'
...
nosv_reduced, _ = FD.format_inputs(datafile, targetfile, testSamples, reduced_version='3.4', remove_largest_n=5,
                                   no_sv=True, drop_empty_vectors=False)
nomut_reduced, _ = FD.format_inputs(datafile, targetfile, testSamples, reduced_version='3.4', remove_largest_n=5,
                                    no_muts=True, drop_empty_vectors=False)
ploidy_reduced, _ = FD.format_inputs(datafile, targetfile, testSamples, reduced_version='3.4', remove_largest_n=5,
                                     ploidy=True, drop_empty_vectors=False)
coo_reduced, _ = FD.format_inputs(datafile, targetfile, testSamples, reduced_version='3.4', remove_largest_n=5,
                                  coo=True, drop_empty_vectors=False)
coo_ploidy_reduced, _ = FD.format_inputs(datafile, targetfile, testSamples, reduced_version='3.4', remove_largest_n=5,
...
models_2 = ['NN_evaluation_seeds1_100_folds5_reducedV3.4_coo_removeN5',
            'NN_evaluation_seeds1_100_folds5_ploidy_reducedV3.4_removeN5',
            'NN_evaluation_seeds1_100_folds5_ploidy_reducedV3.4_coo_removeN5']
model_names = ['NN_reducedV3.4_removeN5_coo_nfeatures22_testsetEval',
               'NN_reducedV3.4_removeN5_ploidy_nfeatures22_testsetEval',
               'NN_reducedV3.4_removeN5_coo_ploidy_nfeatures23_testsetEval']

...
p = ggplot(resultsDropout_2, aes(x=1-dropout_probability, y=Performance)) +
  ...
  ylim(c(0, 1)) +
  ggtitle('Dropout') +
  scale_x_reverse(expand = c(0.01, 0), breaks=seq(0, 1, 0.1), limits=c(1.01, 0))
...
ggsave("plots/performance_dropout.jpeg", p3, width=12, height=8)
ggsave("plots/paper_figures/performance_dropout.pdf", p3)
...
ggsave("plots/confidence_dropout.jpeg", p)
ggsave("plots/paper_figures/confidence_dropout.pdf", p)
...
ggsave("plots/accuracy_dropout.jpeg", p)
ggsave("plots/paper_figures/accuracy_dropout.pdf", p)
...
ggsave("plots/kappa_dropout.jpeg", p)
ggsave("plots/paper_figures/kappa_dropout.pdf", p)
...
ggsave("plots/performance_addIn.jpeg", p3, width = 12, height=8)
ggsave("plots/paper_figures/performance_addIn.pdf", p3)
...
ggsave("plots/accuracy_addIn.jpeg", p)
ggsave("plots/paper_figures/accuracy_addIn.pdf", p)
...
ggsave("plots/kappa_addIn.jpeg", p)
ggsave("plots/paper_figures/kappa_addIn.pdf", p)
...
ggsave("plots/confidence_addIn.jpeg", p)
ggsave("plots/paper_figures/confidence_addIn.pdf", p)

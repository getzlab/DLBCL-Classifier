...
resultsCCF = read.csv('ccf_threshold_experiment/resultstable_ccf_threshold_train.txt', sep='\t')
...
ggsave("plots/kappa_ccf.jpeg", p_calib)
ggsave("plots/paper_figures/kappa_ccf.pdf", p_calib)
ggsave("plots/accuracy_ccf.jpeg", p_acc)
ggsave("plots/paper_figures/accuracy_ccf.pdf", p_acc)
ggsave("plots/performance_ccf.jpeg", p3)
ggsave("plots/paper_figures/performance_ccf.pdf", p3, width=10, height=8)
ggsave("plots/confidence_ccf.jpeg", p_conf)
ggsave("plots/paper_figures/confidence_ccf.pdf", p_conf)

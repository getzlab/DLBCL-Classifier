...
step2B_models = c('NN_reducedV3.4_removeN5_nfeatures21',
                  'NN_ploidy_reducedV3.4_coo_removeN5_nfeatures23',
                  'NN_reducedV3.4_coo_removeN5_nfeatures22',
                  'NN_ploidy_reducedV3.4_removeN5_nfeatures22')

current_table = performancetable[step2B_models, ]

current_table['NN_reducedV3.4_removeN5_nfeatures21', 'Model'] = 'Step2B winner'
...
output_fn = 'plots/combined_performance_step2C'
widths = c(2.3,1,1)
...
ggsave(paste(output_fn, '.jpeg', sep=''), p4, width=11, height=8 * 7/20)
ggsave(paste(output_fn, '.pdf', sep=''), p4, width=11, height=8 * 7/20)
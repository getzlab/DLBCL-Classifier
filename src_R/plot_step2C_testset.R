...
step2T_models = c('NN_reducedV3.4_removeN5_nfeatures21_testsetEval',
                  'NN_reducedV3.4_removeN5_ploidy_nfeatures22_testsetEval',
                  'NN_reducedV3.4_removeN5_coo_nfeatures22_testsetEval',
                  'NN_reducedV3.4_removeN5_coo_ploidy_nfeatures23_testsetEval')

current_table = performancetable[step2T_models, ]
current_table['NN_reducedV3.4_removeN5_nfeatures21_testsetEval', 'Model'] = 'Winning model'

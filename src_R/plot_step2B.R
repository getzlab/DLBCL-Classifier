...
step2B_models = c(step2B_models, 'NN_reducedV3.2_removeN5_nfeatures21')

current_table = performancetable[step2B_models, ]
current_table['NN_reducedV3.2_removeN5_nfeatures21', 'Model'] = 'Step2A winner'
...
output_fn = 'plots/combined_performance_step2B'
widths = c(2.3,1,1)
